  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-semibold tracking-normal">Visao geral</h1>
        <p className="max-w-3xl text-sm text-muted-foreground">
          Base autenticada do VENATTO ERP com tenant, perfil interno e usuarios do tenant validados.
        </p>
      </div>
